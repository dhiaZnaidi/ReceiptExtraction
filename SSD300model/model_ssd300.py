...
Original file is located at
    https://colab.research.google.com/drive/1EIcOkkiWrMtN7EWNehjIKMnmVljxhi7J
"""
...
class SSD300(tf.keras.Model):
    def __init__(self, num_categories=10, floatType=32):
        ...
        '''
            Cone Implementation
        '''
        self.VGG16 = VGG16_backbone(input_shape=(300,300, 3))
        ...
        # fc7
        self.stage_7_1_1024 = Conv2D(filters=1024, kernel_size=(1, 1), padding="same", activation="relu", name="FC7_to_Conv7")
        # conv8_1
        self.stage_8_1_256 = Conv2D(filters=256, kernel_size=(1, 1), activation="relu", name="Conv8_1")
        # conv8_2
        ...
        # conv9_1
        self.stage_9_1_128 = Conv2D(filters=128, kernel_size=(1, 1), activation="relu", name="Conv9_1")
        # conv9_2
        ...
        # conv10_1
        self.stage_10_1_128 = Conv2D(filters=128, kernel_size=(1, 1), activation="relu", name="Conv10_1")
        # conv10_2
        self.stage_10_2_256 = Conv2D(filters=256, kernel_size=(3, 3), activation="relu", name="Conv10_2")
        # conv11_1
        self.stage_11_1_128 = Conv2D(filters=128, kernel_size=(1, 1), activation="relu", name="Conv11_1")
        # conv11_2
        self.stage_11_2_256 = Conv2D(filters=256, kernel_size=(3, 3), activation="relu", name="Conv11_2")
        ...
        self.stage_4_conf = Conv2D(filters=4 * num_categories, kernel_size=(3, 3), padding="same", name="conf_stage4")
        self.stage_7_conf = Conv2D(filters=6 * num_categories, kernel_size=(3, 3), padding="same", name="conf_stage7")
        self.stage_8_conf = Conv2D(filters=6 * num_categories, kernel_size=(3, 3), padding="same", name="conf_stage8")
        self.stage_9_conf = Conv2D(filters=6 * num_categories, kernel_size=(3, 3), padding="same", name="conf_stage9" )
        self.stage_10_conf = Conv2D(filters=4 * num_categories, kernel_size=(3, 3), padding="same", name="conf_stage10")
        self.stage_11_conf = Conv2D(filters=4 * num_categories, kernel_size=(3, 3), padding="same", name="conf_stage11")
        ...
        self.scales = [0.1, 0.2, 0.375, 0.55, 0.625, 0.75]
    ...
    def load_vgg16_imagenet_weights(self):
        ...
        for i in range(len(self.VGG16_stage_4.layers)):
            self.VGG16_stage_4.get_layer(index=i).set_weights(vgg16_original.get_layer(index=i + 1).get_weights())

        for j in range(len(self.VGG16_stage_5.layers)):
            self.VGG16_stage_5.get_layer(index=j).set_weights(vgg16_original.get_layer(index=i + j + 2).get_weights())
    ...
    def recursive_nms(self, boxes_origin: tf.Tensor, classes_origin: tf.Tensor, scores_origin: tf.Tensor):
        """
    ...
    def getPredictionsFromConfsLocs(self, confs_pred, locs_pred, score_threshold=0.2, box_encoding="center", default=False):
        """
