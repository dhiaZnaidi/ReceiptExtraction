...
Original file is located at
    https://colab.research.google.com/drive/1N_vJuLq6xbmPdCBWYuOMrmPpRCbSJgRi
"""
...
def train(model, optimizer, imgs, confs, locs, weights_path, num_epoch=250, inter_save=5):
    ...
    Args:
        ...
        - ReceiptDetection class from data/
    ...
    for epoch in range(num_epoch):
        ...
        for i in tqdm(range(len(imgs))):
            ...
            with tf.GradientTape() as tape:
                ...
                # calculate loss
                confs_loss, locs_loss = model.calculateLoss(confs_pred, confs_gt, locs_pred, locs_gt)
